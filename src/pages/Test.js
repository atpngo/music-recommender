...
import {Dialog, Stack, Paper, List, Autocomplete, TextField, Button} from '@mui/material';
                ...
                <div style={{width: '75vw', height: '75vh', display: 'flex', padding: '30px'}}>
                    <Stack direction="column" sx={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <Stack direction="row" sx={{marginTop: '30px'}}>
                            <Autocomplete disablePortal options={tmp} renderInput={(params) => <TextField {...params} color="green" variant="outlined" label="Select Playlist"/>} sx={{width: '50vw', backgroundColor: 'rgb(255,255,255,0.5)', borderRadius: '20px', outline: 'none'}} />
